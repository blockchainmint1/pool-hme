...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "TXC merged mining pool. Live hashrate, active miners, merged-mining across LTC / DOGE / ISK / TXC / ZCU, LTC payouts daily and DOGE payouts hourly over threshold. Part of the honest.money ecosystem." },
      { name: "author", content: "TEXITcoin" },
      { property: "og:title", content: "TEXITcoin Pool — Sound-money mining, made simple" },
      { property: "og:description", content: "TXC merged mining pool. Live hashrate, active miners, merged-mining across LTC / DOGE / ISK / TXC / ZCU, LTC payouts daily and DOGE payouts hourly over threshold. Part of the honest.money ecosystem." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "TEXITcoin Pool — Sound-money mining, made simple" },
      { name: "twitter:description", content: "TXC merged mining pool. Live hashrate, active miners, merged-mining across LTC / DOGE / ISK / TXC / ZCU, LTC payouts daily and DOGE payouts hourly over threshold. Part of the honest.money ecosystem." },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('hme-theme')||'dark';var d=t!=='light';var c=document.documentElement.classList;c.toggle('dark',d);c.toggle('light',!d);document.documentElement.style.colorScheme=d?'dark':'light';}catch(e){}})();`,
          }}
        />
      </head>
      <body>
